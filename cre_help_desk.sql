...
CREATE TABLE [Users] (
    ...
    [user_type_code] CHAR(20) NOT NULL,
...
/*    [eg Assigned, Open, Closed] VARCHAR(1), */
...
CREATE TABLE [Ref_Equipment_Types] (
    [equipment_type_code] CHAR(20) NOT NULL,
